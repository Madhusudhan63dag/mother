...
import product1 from '../assets/card1.webp';
import product2 from '../assets/card2.webp';
import product3 from '../assets/card3.webp';
import product4 from '../assets/card4.webp';
    ...
    const posts = [
        {
            ...
            caption: 'Support your alcohol-free journey naturally with Dr. Alcofree #SobrietySupport #DrAlcofree'
        },
        {
            id: 2,
            image: product2,
            link: 'https://www.instagram.com/p/DEZwNxBS4m9/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==',
            caption: 'Powerful herbal detox blend to cleanse and heal #LiverCare #NaturalHealing'
        },
        {
            id: 3,
            image: product3,
            link: 'https://www.instagram.com/p/CteRsdQvPRi/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==',
            caption: 'Boost clarity and reduce cravings with a natural solution #SoberLiving'
        },
        {
            id: 4,
            image: product4,
            link: 'https://www.instagram.com/p/CtN6EuALgbF/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==',
            caption: 'Daily wellness for alcohol-free living #HolisticRecovery'
        }
    ];
        ...
        <div className="bg-gradient-to-b from-white to-gray-50 py-16">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-12 space-y-4">
                    ...
                    <p className="text-gray-600 text-lg">@dr.alcofree</p>
                </div>
                ...
                <div className="text-center">
                    <a
                        href="https://www.instagram.com/dr.alcofree/"
                        target="_blank"
                        rel="noopener noreferrer"
